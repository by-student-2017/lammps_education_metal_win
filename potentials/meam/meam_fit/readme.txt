...
Note: It would have been nice if all the data were experimental values, but since there are none, DFT is used. Since the Ec of DFT differs greatly from the experimental value for Fe, etc., Ec is calculated using the experimental value, and in the case of alloys, 
