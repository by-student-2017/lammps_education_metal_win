...
#-----------------------------------------------------------------------
echo -n "" > energy_data_for_isolated_atom.txt
echo "Element, Total energy [Ry], Pseudo file" >> energy_data_for_isolated_atom.txt
...
#-----------------------------------------------------------------------
  ...
  echo "${element_name}, ${TOTEN}, ${upf_name}" >> energy_data_for_isolated_atom.txt
end
#-----------------------------------------------------------------------
