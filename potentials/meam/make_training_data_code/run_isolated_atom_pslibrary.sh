...
date > log.txt
echo "#-----------------------------------------------------------------" >> log.txt
echo "# DFT:${DFT}, spin:${nspin}" >> log.txt
...
#-----------------------------------------------------------------------
  ...
  cutoff_wfc=$(grep "  kinetic-energy cutoff  " isolated_atom.out | sed 's/.*=//g' | sed 's/Ry//g' | sed 's/ //g')
  cutoff_rho=$(grep "  charge density cutoff  " isolated_atom.out | sed 's/.*=//g' | sed 's/Ry//g' | sed 's/ //g')
