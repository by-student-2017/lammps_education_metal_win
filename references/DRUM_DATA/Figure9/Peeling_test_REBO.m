...
%%
load MS_peeling_REBO.mat
h1_CM = load('CM_h1_REBO.csv');
h5_CM = load('CM_h5_REBO.csv');
h11_CM = load('CM_h11_REBO.csv');
...
plot(data_adhesion_profile_h1_REBO(1,:,2),data_adhesion_profile_h1_REBO(1,:,3),'--','LineWidth',3,'MarkerSize',5,'Color',dark_purple)
plot(data_adhesion_profile_h5_REBO(1,:,2),data_adhesion_profile_h5_REBO(1,:,3),'--','LineWidth',3,'MarkerSize',5,'Color',light_blue)
plot(data_adhesion_profile_h11_REBO(1,:,2),data_adhesion_profile_h11_REBO(1,:,3),'--','LineWidth',3,'MarkerSize',5,'Color',coral)
