...
#   python3 analysis.py
# Or
#   python3 analysis.py -r 3.0 -f dump.Sigma5-tilt37_xz.lmp_T300_Vel0.01 -fr 800 -sv 800 -sp "Si C" -n 5 -sc False -gz False -bn 20 -t "tersoff"
...
if __name__ == "__main__":
  ...
  parser.add_argument("-f",  type=str,   default='dump.Sigma5-tilt37_xz.lmp_T300_Vel0.01', help='Filename')
  ...
  parser.add_argument("-gz", type=bool,  default=False,  help='If file is gzipped (default: False)')
  ...
  # Note: python3 analysis.py -r 3.0 -f dump.Sigma5-tilt37_xz.lmp_T300_Vel0.01 -fr 800 -sv 800 -sp "Si C" -n 5 -sc False -gz False -bn 20 -t "tersoff"
