function EAM_Parameters_Fitting
 ...
 x_Cu = [2.5045 0.175425 8.713725 6.906629 0.560027 3.648665];
 ...
 ri_PdCuH025_T_25_25_25 = PdCuH025_T_sorted_6x6x6_25_25_25(:,:);
 ri_PdCuH025_T_75_75_75 = PdCuH025_T_sorted_6x6x6_75_75_75(:,:);
 ri_PdCuH025_T_25_75_75 = PdCuH025_T_sorted_6x6x6_25_75_75(:,:);
 ...
 ri_PdCuH100_O1_O2_O2_O2 = PdCuH100_O1_O2_O2_O2_sorted_6x6x6(:,:);
 ...
 index_PdCuH025_o1_Pd = find(ismember(ri_PdCuH025_o1,ra_1,'rows'));
 index_PdCuH025_o1_Cu = find(ismember(ri_PdCuH025_o1,ra_2,'rows'));
 index_PdCuH025_o1_H = find(ismember(ri_PdCuH025_o1,ra_3,'rows'));

 ra_1 = [1 1 1 0]; % face center Pd
 ra_2 = [2 0 0 0]; % corner Cu
 ra_3 = [3 1 0 0]; % edge H
 index_PdCuH025_o2_Pd = find(ismember(ri_PdCuH025_o2,ra_1,'rows'));
 index_PdCuH025_o2_Cu = find(ismember(ri_PdCuH025_o2,ra_2,'rows'));
 index_PdCuH025_o2_H = find(ismember(ri_PdCuH025_o2,ra_3,'rows'));
 ...
 ra_3 = [3 1 1 1]; % body center H
 ra_4 = [3 1 0 0]; % edge H
 index_PdCuH050_O1_O2_Pd = find(ismember(ri_PdCuH050_O1_O2,ra_1,'rows'));
 index_PdCuH050_O1_O2_Cu = find(ismember(ri_PdCuH050_O1_O2,ra_2,'rows'));
 index_PdCuH050_O1_O2_H_O1 = find(ismember(ri_PdCuH050_O1_O2,ra_3,'rows'));
 index_PdCuH050_O1_O2_H_O2 = find(ismember(ri_PdCuH050_O1_O2,ra_4,'rows'));

 ra_1 = [1 1 1 0]; % face center Pd
 ra_2 = [2 0 0 0]; % corner Cu
 ra_3 = [3 1 0 0]; % edge H
 index_PdCuH050_O2_O2_Pd = find(ismember(ri_PdCuH050_O2_O2,ra_1,'rows'));
 index_PdCuH050_O2_O2_Cu = find(ismember(ri_PdCuH050_O2_O2,ra_2,'rows'));
 index_PdCuH050_O2_O2_H = find(ismember(ri_PdCuH050_O2_O2,ra_3,'rows'));
 ri_PdCuH050_TE1_TE2 = PdCuH050_T_sorted_6x6x6_252525_752525(:,:);
 ...
 ra_3 = [3 .5 .5 .5]; % TE H
 ra_4 = [3 1.5 .5 .5]; % TE H
 index_PdCuH050_TE1_TE2_Pd = find(ismember(ri_PdCuH050_TE1_TE2,ra_1,'rows'));
 index_PdCuH050_TE1_TE2_Cu = find(ismember(ri_PdCuH050_TE1_TE2,ra_2,'rows'));
 index_PdCuH050_TE1_TE2_H_TE1 = find(ismember(ri_PdCuH050_TE1_TE2,ra_3,'rows'));
 index_PdCuH050_TE1_TE2_H_TE2 = find(ismember(ri_PdCuH050_TE1_TE2,ra_4,'rows'));
 ri_PdCuH050_TE1_TE8 = PdCuH050_T_sorted_6x6x6_252525_757575(:,:);
 ...
 index_PdCuH050_TE1_TE8_Pd = find(ismember(ri_PdCuH050_TE1_TE8,ra_1,'rows'));
 index_PdCuH050_TE1_TE8_Cu = find(ismember(ri_PdCuH050_TE1_TE8,ra_2,'rows'));
 index_PdCuH050_TE1_TE8_H_TE1 = find(ismember(ri_PdCuH050_TE1_TE8,ra_3,'rows'));
 index_PdCuH050_TE1_TE8_H_TE8 = find(ismember(ri_PdCuH050_TE1_TE8,ra_4,'rows'));

 ra_1 = [1 1 1 0]; % face center Pd
 ra_2 = [2 0 0 0]; % corner Cu
 ra_3 = [3 1 1 1]; % body center H
 ra_4 = [3 1 0 0]; % edge H
 index_PdCuH075_O1_O2_O2_Pd = find(ismember(ri_PdCuH075_O1_O2_O2,ra_1,'rows'));
 index_PdCuH075_O1_O2_O2_Cu = find(ismember(ri_PdCuH075_O1_O2_O2,ra_2,'rows'));
 ...
 ra_3 = [3 1 0 0]; % edge H
 % ra_3 = [3 0 0 1]; % edge H
 index_PdCuH075_O2_O2_O2_Pd = find(ismember(ri_PdCuH075_O2_O2_O2,ra_1,'rows'));
 index_PdCuH075_O2_O2_O2_Cu = find(ismember(ri_PdCuH075_O2_O2_O2,ra_2,'rows'));
 index_PdCuH075_O2_O2_O2_H = find(ismember(ri_PdCuH075_O2_O2_O2,ra_3,'rows'));

 ra_1 = [1 1 1 0]; % face center Pd
 ra_2 = [2 0 0 0]; % corner Cu
 ra_3 = [3 .5 .5 .5]; % TE H
 % ra_4 = [3 1.5 .5 .5]; % TE H
 index_PdCuH075_T_Pd = find(ismember(ri_PdCuH075_T,ra_1,'rows'));
 index_PdCuH075_T_Cu = find(ismember(ri_PdCuH075_T,ra_2,'rows'));
 index_PdCuH075_T_H = find(ismember(ri_PdCuH075_T,ra_3,'rows'));
 ...
 ra_2 = [2 0 0 0]; % corner Cu
 ra_3 = [3 .5 .5 .5]; % TE H
 index_PdCuH100_T_Pd = find(ismember(ri_PdCuH100_T,ra_1,'rows'));
 index_PdCuH100_T_Cu = find(ismember(ri_PdCuH100_T,ra_2,'rows'));
 index_PdCuH100_T_H = find(ismember(ri_PdCuH100_T,ra_3,'rows'));
 ...
 ra_3 = [3 .5 1.5 .5]; % TE H
 ra_4 = [3 .5 .5 1.5]; % TE H
 index_PdCuH050_TE3_TE4_Pd = find(ismember(ri_PdCuH050_TE3_TE4,ra_1,'rows'));
 index_PdCuH050_TE3_TE4_Cu = find(ismember(ri_PdCuH050_TE3_TE4,ra_2,'rows'));
 index_PdCuH050_TE3_TE4_H_TE3 = find(ismember(ri_PdCuH050_TE3_TE4,ra_3,'rows'));
 index_PdCuH050_TE3_TE4_H_TE4 = find(ismember(ri_PdCuH050_TE3_TE4,ra_4,'rows'));
 ...
 index_PdCuH050_TE3_TE6_Pd = find(ismember(ri_PdCuH050_TE3_TE6,ra_1,'rows'));
 index_PdCuH050_TE3_TE6_Cu = find(ismember(ri_PdCuH050_TE3_TE6,ra_2,'rows'));
 index_PdCuH050_TE3_TE6_H_TE3 = find(ismember(ri_PdCuH050_TE3_TE6,ra_3,'rows'));
 index_PdCuH050_TE3_TE6_H_TE6 = find(ismember(ri_PdCuH050_TE3_TE6,ra_4,'rows'));
 ...
 X0_CuH = [0.755217 2.16562 1.76185 2.3539];
 ...
 [x,fval] = fmincon(@objfun_18_07_09,X0_CuH,[],[],[],[],Xl_CuH,Xu_CuH,...
 [],options)
