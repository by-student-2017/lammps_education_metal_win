...
%***************************************************************
 ...
 d6 = (Ec_Pd075Cu025H050_TE3_TE4 - (Ec_exp_PdCuH050_TE3_TE4))^2;
 d7 = (Ec_Pd075Cu025H050_TE1_TE8 - (Ec_exp_PdCuH050_TE1_TE8))^2;
 d8 = (Ec_Pd075Cu025H075_O1_O2_O2 - (Ec_exp_PdCuH075_O1_O2_O2))^2;
 d9 = (Ec_Pd075Cu025H075_O2_O2_O2 - (Ec_exp_PdCuH075_O2_O2_O2))^2;
 d10 = (Ec_Pd075Cu025H075_TE1_TE2_TE3 - (Ec_exp_PdCuH075_TE1_TE2_TE3))^2;
 d11 = (Ec_Pd075Cu025H075_TE1_TE2_TE8 - (Ec_exp_PdCuH075_TE1_TE2_TE8))^2;
 d12 = (Ec_Pd075Cu025H100_O1_O2_O2_O2 - (Ec_exp_PdCuH100_O1_O2_O2_O2))^2;
...
function f = S(i,j,r,a,N,index,t1,y,f_11,dfdr_11,X0,dFdrho,X1,dphidr_11,...
  X2,rc_1,t2,x,f_22,dfdr_22,X3,dphidr_12,X4,rc_2)
...
function [afcce,Ecfcce,c11e,c12e,c44e,Bme,Eve,abcce,Ecbcce,cpre] ...
 ...
 B = [1.04;0.793;1.67;1.38;1.804;1.9547;2.83;0.5*1.6021766208]; % from Rayne
...
function f = d2fdr2_PdPd_cut(rij,X)
 global rc_1;
 global NP;
 f = d2fdr2_PdPd(rij,X)- ((NP-1)/rc_1) * (rij/rc_1)^(NP-2) * dfdr_PdPd(rc_1,X);
end
...
function f = d2fdr2_HH_cut(rij,X)
 global rc_2;
 global NP2;
 f = d2fdr2_HH(rij,X)- ((NP2-1)/rc_2) * (rij/rc_2)^(NP2-2) * dfdr_HH(rc_2,X);
end
