...
82
 ...
 global ri_PdCuH050_T_752525;
 global index_PdCuH050_T_Pd_752525
 global index_PdCuH050_T_Cu_752525
 global index_PdCuH050_T_H_752525
 global ri_PdCuH050_T_757575;
 global index_PdCuH050_T_Pd_757575
 global index_PdCuH050_T_Cu_757575
 global index_PdCuH050_T_H_757575
...
[aFcce_Pd,EcFcce_Pd,C11e_Pd,C12e_Pd,C44e_Pd,Bme_Pd,Eve_Pd,aBc
ce_Pd,...
...
[aFcce_Cu,EcFcce_Cu,C11e_Cu,C12e_Cu,C44e_Cu,Bme_Cu,Eve_Cu,aBc
ce_Cu,...
...
86
 ...
 1,XX,@f_PdPd,X0_PdPd,...
 @phi_PdCu,X5_PdCu,rc_1);
 Ec_Pd075Cu025H000 = ( xx * Ec_Pd_12 + yy * Ec_Cu_12 )/(xx 
+ yy);
%***************************************************************
...
Ec_Cu_12 + zzz * Ec_H_12 + zzz * Ec_H_22)/(xx + yy + zzz + 
zzz);
%***************************************************************
...
Ec_Cu_12 + zz * Ec_H_12 + zzz * Ec_H_22)/(xx + yy + zz + 
zzz);
%***************************************************************
...
* Ec_Cu_12 + zz * Ec_H_12 + zz * Ec_H_22 + zz * Ec_H_32 + zz 
* Ec_H_42)/(xx + yy + 4*zz);
 d0 = (Ec_Pd075Cu025H000 - (Ec_exp_PdCuH000))^2;
 d1 = (Ec_Pd075Cu025H025_O1 - (Ec_exp_PdCuH025_O1))^2;
 d2 = (Ec_Pd075Cu025H025_O2 - (Ec_exp_PdCuH025_O2))^2;
 d3 = (Ec_Pd075Cu025H025_TE1 - (Ec_exp_PdCuH025_TE1))^2;
 d4 = (Ec_Pd075Cu025H050_O1_O2 - (Ec_exp_PdCuH050_O1_O2))^2;
 d5 = (Ec_Pd075Cu025H050_O2_O2 - (Ec_exp_PdCuH050_O2_O2))^2;
 d6 = (Ec_Pd075Cu025H050_TE3_TE4 -
(Ec_exp_PdCuH050_TE3_TE4))^2;
 d7 = (Ec_Pd075Cu025H050_TE1_TE8 -
(Ec_exp_PdCuH050_TE1_TE8))^2;
 d8 = (Ec_Pd075Cu025H075_O1_O2_O2 -
(Ec_exp_PdCuH075_O1_O2_O2))^2;
 d9 = (Ec_Pd075Cu025H075_O2_O2_O2 -
(Ec_exp_PdCuH075_O2_O2_O2))^2;
 d10 = (Ec_Pd075Cu025H075_TE1_TE2_TE3 -
(Ec_exp_PdCuH075_TE1_TE2_TE3))^2;
 d11 = (Ec_Pd075Cu025H075_TE1_TE2_TE8 -
(Ec_exp_PdCuH075_TE1_TE2_TE8))^2;
 d12 = (Ec_Pd075Cu025H100_O1_O2_O2_O2 -
(Ec_exp_PdCuH100_O1_O2_O2_O2))^2;
 d13 = (Ec_Pd075Cu025H100_TE1_TE2_TE3_TE4 -
(Ec_exp_PdCuH100_TE1_TE2_TE3_TE4))^2;
 d14 = (Ec_Pd075Cu025H100_TE1_TE2_TE7_TE8 -
(Ec_exp_PdCuH100_TE1_TE2_TE7_TE8))^2;
109
 f = sqrt(d1 + d2 + d3 + d4 + d5 + d6 + d7 + d8 
...
t2,x,f_22,dfdr_22,d2fdr2_22,X3,phi_12,dphidr_12,d2phidr2_12,X4,r
c_2)
 Ec_ = 
Ec(r,a,index,t1,y,f_11,X0,F,X1,phi_11,X2,rc_1,t2,x,f_22,X3,ph
i_12,X4,rc_2);
 dEda_ = 
dEda(r,a,index,t1,y,f_11,dfdr_11,X0,dFdrho,X1,dphidr_11,X2,rc
_1,...
...
%***************************************************************
function [Ec_,dEda_,C11,C12,C44,Bm_,Ev_] = 
fitProperties(r,a,N,index,...
...
dphidr_11,d2phidr2_11,X2,rc_1,t2,x,f_22,dfdr_22,d2fdr2_22,X3,...
 ...
 % Cohesive Energy
 Ec_ = 
Ec(r,a,index,t1,y,f_11,X0,F,X1,phi_11,X2,rc_1,t2,x,f_22,X3,..
.
 phi_12,X4,rc_2);
 % First Derivative of Ec with respect to a
 dEda_ = 
dEda(r,a,index,t1,y,f_11,dfdr_11,X0,dFdrho,X1,dphidr_11,X2,..
.
 rc_1,t2,x,f_22,dfdr_22,X3,dphidr_12,X4,rc_2);
 % C11 Elastic Constant
 C11 = 
Cijkl(1,1,1,1,r,a,N,index,t1,y,f_11,dfdr_11,d2fdr2_11,X0,...
...
110
 C12 = 
Cijkl(1,1,2,2,r,a,N,index,t1,y,f_11,dfdr_11,d2fdr2_11,X0,...
 dFdrho,d2Fdrho2,X1,dphidr_11,d2phidr2_11,X2,rc_1,...
t2,x,f_22,dfdr_22,d2fdr2_22,X3,dphidr_12,d2phidr2_12,X4,rc_2)
;
 % C44 Elastic Constant
 C44 = 
Cijkl(2,3,2,3,r,a,N,index,t1,y,f_11,dfdr_11,d2fdr2_11,X0,...
 dFdrho,d2Fdrho2,X1,dphidr_11,d2phidr2_11,X2,rc_1,...
t2,x,f_22,dfdr_22,d2fdr2_22,X3,dphidr_12,d2phidr2_12,X4,rc_2)
;
 % Bulk Modulus
...
%***************************************************************
function f = 
Ec3(ri,a,index,t1,y,f_11,X0,F_11,X1,phi_11,X2,rc_1,t2,x,...
...
%***************************************************************
function f = 
Cijkl(i,j,k,l,r,a,N,index,t1,y,f_11,dfdr_11,d2fdr2_11,X0,...
 ...
 Wijkl_11 = y * 
Wijkl(index,t1,r,a,rc_1,dfdr_11,d2fdr2_11,X0,i,j,k,l);
 Bijkl_11 = y * 
Bijkl(index,t1,r,a,rc_1,dphidr_11,d2phidr2_11,X2,i,j,k,l);
 
 if nargin == 31
 Rho_12 = x * Rho(index,t2,r,a,rc_2,f_22,X3);
 Vij_12 = x * 
Vij(index,t2,r,a,rc_2,dfdr_22,X3,i,j,0,0);
 Vkl_12 = x * 
Vij(index,t2,r,a,rc_2,dfdr_22,X3,0,0,k,l);
 Wijkl_12 = x * 
Wijkl(index,t2,r,a,rc_2,dfdr_22,d2fdr2_22,X3,i,j,k,l);
 Bijkl_12 = x * 
...
;
 ...
 V = (a^3)/N;
 Cijkl = (1/V)*( d2Fdrho2_1*(Vij_11 + Vij_12)*(Vkl_11 + 
Vkl_12) +...
...
%***************************************************************
function f = 
S(i,j,r,a,N,index,t1,y,f_11,dfdr_11,X0,dFdrho,X1,dphidr_11,X2,rc
_1,t2,x,f_22,dfdr_22,X3,dphidr_12,X4,rc_2)
 Rho_12 = 0;
 Vij_12 = 0;
 Aij_12 = 0;
 %
 ...
 Aij_12 = x *
Aij(index,t2,r,a,rc_2,dphidr_12,X4,i,j,0,0);
 end
 Rho_1 = Rho_11 + Rho_12;
 dFdrho_1 = dFdrho(Rho_1,X1);
 V = (a^3)/N;
 f = (1/V) * (Aij_11 + Aij_12 + dFdrho_1 * (Vij_11 + 
Vij_12));
end
%***************************************************************
...
%***************************************************************
% Second derivative of Cohesive Energy with respect to a for 
Interstitial
% Solid Solution
%***************************************************************
function f = 
d2Eda2(ri,a,index,t1,y,f_11,dfdr_11,d2fdr2_11,X0,...
 ...
 d2Phida2_11 = y * 
d2Phida2(index,t1,ri,a,rc_1,d2phidr2_11,X2);
 if nargin == 24
 Rho_12 = x * Rho(index,t2,ri,a,rc_2,f_22,X3);
 dRhoda_12 = x * dRhoda(index,t2,ri,a,rc_2,dfdr_22,X3);
 d2Rhoda2_12 = x * 
d2Rhoda2(index,t2,ri,a,rc_2,d2fdr2_22,X3);
 d2Phida2_12 = x * 
d2Phida2(index,t2,ri,a,rc_2,d2phidr2_12,X4);
 end
 Rho_1 = Rho_11 + Rho_12;
 dRhoda_1 = dRhoda_11 + dRhoda_12;
 d2Rhoda2_1 = d2Rhoda2_11 + d2Rhoda2_12;
 d2Fda2_1 = 
d2Fda2(dFdrho,d2Fdrho2,Rho_1,dRhoda_1,d2Rhoda2_1,X1);
...
%***************************************************************
% Total pair potential energy for a central atom as function of 
interatomic
% distance
...
% Total first derivative of pair potential with respect to 
interatomic 
% distance rij
function f = dPhidr(index,type,ri,a,rc,dphidr,X)
f = Sumfunc(index,type,ri,a,rc,dphidr,X); 
end
% Total second derivative of pair potential with respect to 
interatomic 
% distance rij
...
116
% Total Electron Density for a central atom as function of 
interatomic
% distance
% index: array index of central atom 
% type : Id of atom type
...
% Total first derivative of electron density with respect to 
interatomic 
% distance rij
function f = dRhodr(index,type,ri,a,rc,dfdr,X) 
 f = Sumfunc(index,type,ri,a,rc,dfdr,X);
end
% Total second derivative of electron density with respect to 
interatomic 
% distance rij
...
% Total first derivative of electron density with respect 
ri,rj,rk, and rl 
...
% First derivative of Atomic Electron Density with respect to 
ri,rj,rk and rl
function f = dfdrijkl(index,type,ri,a,rc,dfdr,X,i,j,k,l)
 f = Sumfuncrijkl(index,type,ri,a,rc,dfdr,X,i,j,k,l,3);
end
% Second derivative of Atomic Electron Density with respect to 
ri,rj,rk and rl
...
119
 ...
 dF = dFdrho_Pd(rho,X);
 f = -
(n/rho^2)*Fe*(rho/rhoe)^n+(n^2/rho)*(1/rhoe)*Fe*(rho/rhoe
)^(n-1)+...
...
% Pd Atomic Electron Density as a function of interatomic 
distance rij
...
% First derivative Pd Atomic Electron Density function with 
respect to rij
...
%***************************************************************
121
% H-H unnormalized pair potential as a function of interatomic 
distance rij 
...
% First derivative of H-H unnormalized pair potential with 
respect to rij 
...
% Secon derivative of H-H unnormalized pair potential with 
respect to rij 
...
% H-H normalized pair potential as a function of interatomic 
distance rij 
...
% First derivative of H-H normalized pair potential with respect 
to rij 
...
% Second derivative of H-H normalized pair potential with 
respect to rij 
...
% H Atomic Electron Density as a function of interatomic 
distance
function f = f_HH(r,X)
 CH = X(1);
 DH = X(2);
...
% Second derivative H Atomic Electron Density with respect to 
rij
...
123
 ...
 EH = 0.0540638;
 % EH = 0.055;
 f = -cH * ( (1/(2+dH))*(rho+EH)^(2+dH) - ((aH + 
bH)/(1+dH))*...
 (rho+EH)^(1+dH) + ((aH * bH)/dH) *(rho+EH)^dH );
end
% First derivative of H unnormalized Embedding function with 
respect to Rho 
...
% Second derivative of H unnormalized Embedding function with 
respect to Rho 
...
% First derivative of Pd-H pair potential with respect to 
interatomic
% destance rij
...
% Second derivative of Pd-H pair potential with respect to 
interatomic
% destance rij
...
127
 ...
 l1(2) = (a/2)*r(ii,3);
 l1(3) = (a/2)*r(ii,4);
 rij = sqrt((l1(1)-cl(1))^2 + (l1(2)-cl(2))^2 + 
(l1(3)-cl(3))^2);
 if rij < rc
 if i ~= 0
 ri = l1(i)-cl(i);
...
128
 ...
 c44 = 
[0.461;0.316;0.42;0.758;1.247;0.7117;0.765;0.05*1.6021766208]
; 
 cpr = [1;1;1;1;1;1;1;0.05*1.6021766208]; 
 % Unrelaxed
 Evfcc = [1.1;0.866;0.9;1.3;1.70;1.54;1.60;0.0];
 B = 
[1.04;0.793;1.67;1.38;1.804;1.9547;2.83;0.5*1.6021766208]; % 
from Rayne
...
%***************************************************************
function [afcce,Ecfcce,C44fcce,Cprfcce,Bmfcce] = 
PdH_parameters(el)
 index1 = 1;
...
129
 Ec = 
[2.119;3.91;3.64024;3.48770;3.37031;3.26966;3.50000;3.50000];
 % Elastic Constants with conv from eV/A^3 to dyne/cm^2 
10^12
 ...
 1.05,1.05] * 1.6021766208; % Pd from Rayne, Zhou values 
added
 afcce = a(index1);
 Ecfcce = Ec(index1);
 C44fcce = C44(index1);
...
function f = phi_PdPd_cut(rij,X)
 global rc_1;
 global NP;
 f = phi_PdPd(rij,X) - phi_PdPd(rc_1,X) + (rc_1/NP) * (1-
(rij/rc_1)^NP )* dphidr_PdPd(rc_1,X);
end
...
function f = f_PdPd_cut(rij,X)
 global rc_1;
 global NP;
 f = f_PdPd(rij,X) - f_PdPd(rc_1,X) + (rc_1/NP) * (1-
(rij/rc_1)^NP) * dfdr_PdPd(rc_1,X);
130
end
...
function f = phi_HH_cut(rij,X)
 global rc_2;
 global NP2;
 f = phi_HH(rij,X) - phi_HH(rc_2,X) + (rc_2/NP2) * (1-
(rij/rc_2)^NP2 )* dphidr_HH(rc_2,X);
end
...
function f = f_HH_cut(rij,X)
 global rc_2;
 global NP2;
 f = f_HH(rij,X) - f_HH(rc_2,X) + (rc_2/NP2) * (1-
(rij/rc_2)^NP2) * dfdr_HH(rc_2,X);
end
131
...
function f = phi_PdH_cut(rij,X)
 global rc_3;
 global NP3;
 f = phi_PdH(rij,X) - phi_PdH(rc_3,X) + (rc_3/NP3) * (1-
(rij/rc_3)^NP3 )* dphidr_PdH(rc_3,X);
end
function f = dphidr_PdH_cut(rij,X)
 global rc_3;
 global NP3;
 f = dphidr_PdH(rij,X) - (rij/rc_3)^(NP3-1) * 
dphidr_PdH(rc_3,X);
end
...
function f = dphidr_PdCu(rij,X)
 ...
 f = .5*( ((-1*f_b*dfdr_a*f_a^-2 + dfdr_b*f_a^-1)*phi_a + 
(f_b*f_a^-1)*dphidr_a)...
...
function f = d2phidr2_PdCu(rij,X) 
 ...
 Phi_ab = 
phi_ab(f_a,dfdr_a,d2fdr2_a,f_b,dfdr_b,d2fdr2_b,phi_a,dphidr_a
,d2phidr2_a,phi_b,dphidr_b,d2phidr2_b);
 Phi_ba = 
phi_ab(f_b,dfdr_b,d2fdr2_b,f_a,dfdr_a,d2fdr2_a,phi_b,dphidr_b
,d2phidr2_b,phi_a,dphidr_a,d2phidr2_a);
133
 f = .5*(Phi_ab + Phi_ba);
end
function f = 
phi_ab(f_a,dfdr_a,d2fdr2_a,f_b,dfdr_b,d2fdr2_b,phi_a,dphidr_a,d2
phidr2_a,phi_b,dphidr_b,d2phidr2_b)
 aa = -1*(dfdr_b*dfdr_a*f_a^-2 + f_b*d2fdr2_a*f_a^-2 -
2*f_b*(dfdr_a^2)*f_a^-3)...
 + (d2fdr2_b*f_a^-1 - dfdr_b*f_a^-2*dfdr_a);
 a = aa*phi_a + (-1*f_b*dfdr_a*f_a^-2 + dfdr_b*f_a^-
1)*dphidr_a;
...
% Table
%***************************************************************
 Model1 = [Ec_Pd075Cu025H025_O1; Ec_Pd075Cu025H025_O2; 
Ec_Pd075Cu025H025_TE1;... 
Ec_Pd075Cu025H050_O1_O2;Ec_Pd075Cu025H050_O2_O2;Ec_Pd075Cu025
H050_TE3_TE4;...
Ec_Pd075Cu025H050_TE1_TE8;Ec_Pd075Cu025H075_O1_O2_O2;Ec_Pd075
Cu025H075_O2_O2_O2;... 
Ec_Pd075Cu025H075_TE1_TE2_TE3;Ec_Pd075Cu025H075_TE1_TE2_TE8;E
c_Pd075Cu025H100_O1_O2_O2_O2;Ec_Pd075Cu025H100_TE1_TE2_TE3_TE
4;Ec_Pd075Cu025H100_TE1_TE2_TE7_TE8];
...
... 
'PdCuH050_O2_O2','PdCuH050_TE3_TE4','PdCuH050_TE1_TE8','PdCuH
075_O1_O2_O2',... 
'PdCuH075_O2_O2_O2','PdCuH075_TE1_TE2_TE3','PdCuH075_TE1_TE2_
TE8','PdCuH100_O1_O2_O2_O2','PdCuH100_TE1_TE2_TE3_TE4','PdCuH
100_TE1_TE2_TE7_TE8'};
 
Columnames = {'Siesta';'Model'};
 Results = 
table(Siesta1,Model1,'VariableNames',Columnames,'RowNames',Ro
wnames)
 ar = 2.1075;
 fig_height = 6;
...
170
 ...
 r = [0:0.01:6];
 plot(r,Phi_HH,'black:',r,Phi_PdH,'black-
.',r,Phi_PdPd,'black--',r,Phi_CuCu,'g:',r,Phi_CuH,'black-
',r,Phi_PdCu,'b:','markersize',3, 'linewidth',4)
 xlabel('r (A^o)','fontsize',24)
 ylabel('Two Body Potential (eV)','fontsize',24)
...
Ec_exp_PdCuH100_TE1_TE2_TE3_TE4; 
Ec_exp_PdCuH100_TE1_TE2_TE7_TE8];
 plot(x,Model1,'kO',x,Siesta1,'blackd','markersize',10, 
'linewidth',3)
 ...
 xticklabels({'PdCuH025 O1','PdCuH025 O2','PdCuH025 
TE1','PdCuH050 O1 O2',...
 'PdCuH050 O2 O2','PdCuH050 TE3 TE4','PdCuH050 TE1 
TE8','PdCuH075 O1 O2 O2',...
 'PdCuH075 O2 O2 O2','PdCuH075 TE123','PdCuH075 
TE128','PdCuH100 O1 O2 O2 O2','PdCuH100 TE1234','PdCuH100 
TE1278'})
 xtickangle(45)
 fig = figure(3);
 fig.Units = 'inches';
 fig.Position = [2 2 fig_width fig_height];
 x = [1:11]';
 Siesta = [Ec_exp_PdCuH025_O1; Ec_exp_PdCuH025_O2; 
Ec_exp_PdCuH025_T;...
 Ec_exp_PdCuH050_O1_O2; Ec_exp_PdCuH050_O2_O2; 
Ec_exp_PdCuH050_T;...
172
...
Ec_Pd075Cu025H075_O1_O2_O2;Ec_Pd075Cu025H075_O2_O2_O2;...
 ...
 Model = 
[Ec_Pd075Cu025H050_TE1_TE2;Ec_Pd075Cu025H050_TE1_TE8;...
 Ec_Pd075Cu025H050_TE3_TE4;Ec_Pd075Cu025H050_TE3_TE6;...
 
Ec_Pd075Cu025H075_TE5_TE6_TE7;Ec_Pd075Cu025H075_TE1_TE2_TE3;.
..
 
Ec_Pd075Cu025H075_TE1_TE2_TE8;Ec_Pd075Cu025H100_TE1_TE5_TE6_T
E7;...
 
Ec_Pd075Cu025H100_TE1_TE2_TE3_TE4;Ec_Pd075Cu025H100_TE1_TE2_T
E7_TE8];
 Siesta = [Ec_exp_PdCuH025_O1; Ec_exp_PdCuH025_O2; 
Ec_exp_PdCuH025_T;...
 Ec_exp_PdCuH050_O1_O2; Ec_exp_PdCuH050_O2_O2; 
...
'PdCuH050_TE3_TE8','PdCuH075_TE5_TE6_TE7','PdCuH075_TE1_TE2_T
E3',...
...
173
 Columnames = {'Model'};
 Results = 
table(Model,'VariableNames',Columnames,'RowNames',Rownames);
end
%***************************************************************
function [Ec_,dEda_]= 
fitProperties_1(r,a,N,index,t1,y,f_11,dfdr_11,d2fdr2_11,X0,...
...
%***************************************************************
function f = 
Ec(ri,a,index,t1,y,f_11,X0,F_11,X1,phi_11,X2,rc_1,t2,x,...
...
(n/rho^2)*Fe*(rho/rhoe)^n+(n^2/rho)*(1/rhoe)*Fe*(rho/rhoe
 ...
 (n/rhoe)*dF*(rho/rhoe)^(-1)-(n/rhoe^2)*F*(rho/rhoe)^(-
2);
 end
end
% First derivative of Pd Embedding Energy Function with respect 
...
function f = dphidr_PdCu(rij,X)
 ...
 f = .5*( ((-1*f_b*dfdr_a*f_a^-2 + dfdr_b*f_a^-1)*phi_a + 
(f_b*f_a^-1)*dphidr_a)...
 + ((-1*f_a*dfdr_b*f_b^-2 + dfdr_a*f_b^-1)*phi_b + 
(f_a*f_b^-1)*dphidr_b) );
197
end
function f = d2phidr2_PdCu(rij,X)
